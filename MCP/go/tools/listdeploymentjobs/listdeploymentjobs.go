...
func ListdeploymentjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listDeploymentJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListDeploymentJobsResponse
...
func CreateListdeploymentjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_listDeploymentJobs",
		mcp.WithDescription("<p>Returns a list of deployment jobs for a fleet. You can optionally provide filters to retrieve specific deployment jobs.</p> <important> <p>This API will no longer be supported as of May 2, 2022. Use it to remove resources that were created for Deployment Service.</p> </important>"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdeploymentjobsHandler(cfg),
	}
}
