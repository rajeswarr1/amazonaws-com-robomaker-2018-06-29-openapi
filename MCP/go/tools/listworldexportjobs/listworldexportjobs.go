...
func ListworldexportjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listWorldExportJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListWorldExportJobsResponse
...
func CreateListworldexportjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_listWorldExportJobs",
		...
		mcp.WithArray("filters", mcp.Description("Input parameter: Optional filters to limit results. You can use <code>generationJobId</code> and <code>templateId</code>.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListworldexportjobsHandler(cfg),
	}
}
