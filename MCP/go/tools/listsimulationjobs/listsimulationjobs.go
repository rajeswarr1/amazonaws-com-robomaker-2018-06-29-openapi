...
func ListsimulationjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/listSimulationJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListSimulationJobsResponse
...
func CreateListsimulationjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_listSimulationJobs",
		mcp.WithDescription("Returns a list of simulation jobs. You can optionally provide filters to retrieve specific simulation jobs. "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListsimulationjobsHandler(cfg),
	}
}
